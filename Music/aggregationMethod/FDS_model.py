...
def FDS(datafile, goldfile):
    ...
    # 真值
    gold = pd.read_csv(truth_value, index_col=None, header=0)
    print(gold)
    gold = gold.iloc[:, :2]
    print(gold.columns)
...
if __name__ == '__main__':
    ...
    # #datafile = '../fillData/data/data-plus_0.csv'
    # #datafile = r'../data/music_feature.csv'
    # # datafile = r'../data/redundancy_2/train_data_7.csv'
    # truth_value = r'../data/train/music_true.csv'
    #
    ...
    for b in range(360, -1, -10):
        ...
        label = round(data.shape[0] / 30800, 3)
